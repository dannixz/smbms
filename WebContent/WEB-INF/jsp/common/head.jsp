...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/user/billShow">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/prolist">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/userlist">用户管理</a></li>
                <li><a href="${pageContext.request.contextPath }/user/rolelist">角色管理</a></li>
