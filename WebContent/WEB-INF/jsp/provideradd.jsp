...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" enctype="multipart/form-data" name="providerForm" method="post" action="${pageContext.request.contextPath }/user/proadd">
			<input type="hidden" name="method" value="add">
                ...
                <div>
                 ...
                 <div>
                    <label for="B_business">企业营业执照：</label>
                    <input type="file" name="attachs" id="B_business" value=""> 
               		<font color="red">${uploadFileError}</font>
                </div>
                 <div>
                    <label for="B_organPath">组织机构代码证：</label>
                    <input type="file" name="attachs" id="B_organPath" value=""> 
               		<font color="red">${uploadFileError}</font>
                </div>
