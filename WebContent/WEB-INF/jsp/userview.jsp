...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p>
            <strong>证件照：</strong>
            <img src="${user.idPicPath}" width="400" height="400" >
            </p>
            <p>
            <strong>工作证照片：</strong>
            <img src="${user.workPicPath}" width="400" height="400">
            </p>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/sys/userview.js"></script>